...
--s : on protein data, this option assesses the dataset for Site Saturation using the DE-Score, as per Fleming & Struck (2026) (see references). On nucleotide data, this assesses the dataset for Site Saturation using the C-Score, as per Kück & Struck (2014)  (see references).
